package com.evalueat.evalueat.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("EvaluEAT");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("EvaluEAT");
        ...
        config.getMapConfigs().put("com.evalueat.evalueat.domain.*", initializeDomainMapConfig(jHipsterProperties));
